...
// Convert a video buffer to WebP (first 5 seconds)
...
// Main function: takes media buffer and optional metadata, returns sticker buffer with EXIF
async function writeExif(media, data = {}) {
  ...
  if (!webpMedia) throw new Error('Failed to convert to WebP')
